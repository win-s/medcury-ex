...
describe('question 2 phone', () => {
  ...
  describe('expected from user story', () => {
    describe('Basic Tests', ()=>{
      ...
      before(()=>{
        directory = `/+1-541-754-3010 156 Alphand_St. <J Steeve>\n 133, Green, Rd. <E Kustur> NY-56423 ;+1-541-914-3010\n
      ...
      it('48-421-674-8974', () => {
        ...
        assert.equal(
          phone(directory, `48-421-674-8974`),
      ...
      it('1-921-512-2222', () => {
        assert.equal
          (phone(directory, `1-921-512-2222`),
      ...
      it('1-908-512-2222', () => {
        assert.equal(
          phone(directory, `1-908-512-2222`),
      ...
      it('1-541-754-3010', () => {
        assert.equal(
          phone(directory, `1-541-754-3010`),
      ...
      it('1-121-504-8974', () => {
        assert.equal(
          phone(directory, `1-121-504-8974`),
      ...
      it('1-498-512-2222', () => {
        assert.equal(
          phone(directory, `1-498-512-2222`),
      ...
      it('1-098-512-2222', () => {
        assert.equal(
          phone(directory, `1-098-512-2222`),
      ...
      it('5-555-555-5555', () => {
        assert.equal(
          phone(directory, `5-555-555-5555`),
